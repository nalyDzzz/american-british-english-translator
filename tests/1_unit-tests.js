...
suite('Unit Tests', () => {
    ...
    test("Highlight translation in Mangoes are my favorite fruit.", (done) => {
        assert.equal(translate.americanToBritish('Mangoes are my favorite fruit.'), `Mangoes are my <span class="highlight">favourite</span> fruit.`);
        assert.include(translate.americanToBritish('Mangoes are my favorite fruit.'), `<span class="highlight">favourite</span>`);
        done();
    });
    test("Highlight translation in I ate yogurt for breakfast.", (done) => {
        assert.equal(translate.americanToBritish('I ate yogurt for breakfast.'), `I ate <span class="highlight">yoghurt</span> for breakfast.`);
        assert.include(translate.americanToBritish('I ate yogurt for breakfast.'), `<span class="highlight">yoghurt</span>`);
        done();
    });
    test("Highlight translation in We watched the footie match for a while.", (done) => {
        assert.equal(translate.britishToAmerican('We watched the footie match for a while.'), `We watched the <span class="highlight">soccer</span> match for a while.`);
        assert.include(translate.britishToAmerican('We watched the footie match for a while.'), `<span class="highlight">soccer</span>`)
        done();
    });
    test("Highlight translation in Paracetamol takes up to an hour to work.", (done) => {
        assert.equal(translate.britishToAmerican('Paracetamol takes up to an hour to work.'), `<span class="highlight">Tylenol</span> takes up to an hour to work.`);
        assert.include(translate.britishToAmerican('Paracetamol takes up to an hour to work.'), `<span class="highlight">Tylenol</span>`)
        done();
    });
});
